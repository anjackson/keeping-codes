...
#### 1.1 Digital Object Properties {.subsectionHead}
...
#### 1.2 Evaluation via Comparing Properties {.subsectionHead}
...
#### 2.1 Characterising Performances {.subsectionHead}
...
#### 2.2 The Trancendence Fallacy {.subsectionHead}
...
#### 2.3 The Nature Of Characterisation {.subsectionHead}
...
#### 3.1 Define ’Essential’ Formats {.subsectionHead}
...
#### 3.2 Focus On Information Content {.subsectionHead}
...
##### 3.2.1 Evaluating Migration Pathways {.subsubsectionHead}
...
#### 3.3 Focus On Critial Properties {.subsectionHead}
...
##### 3.3.1 Evaluating Performances {.subsubsectionHead}
...
##### 3.3.2 Subjectivity Versus Objectivity {.subsubsectionHead}
...
##### 3.3.3 Managing Ambiguity {.subsubsectionHead}
...
#### 3.4 Promises, Statements & Tests {.subsectionHead}
